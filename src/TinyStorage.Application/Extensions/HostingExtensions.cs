...
{
    private static void MapOnPort(this IApplicationBuilder applicationBuilder,
    ...
    public static void MapOnPublicPort(this IApplicationBuilder app,
        Action<IApplicationBuilder> configureAction,
        int defaultPort = 8080) => app.MapOnPort(configureAction, defaultPort);

    public static void MapOnInternalPort(this IApplicationBuilder app,
        Action<IApplicationBuilder> configureAction,
